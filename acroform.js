  ...
  */
  ...
  var toPdfString = function (string) {
    ...
    */
    ...
    var AcroFormCheckCircle = function () {
      AcroFormButton.call(this);
      this.appearanceStreamContent = AcroFormAppearance.CheckCircle.createAppearanceStream();
      this.MK = AcroFormAppearance.CheckCircle.createMK();
      this.AS = "/On";
      this.V = "/On";
    };
  ...
  var AcroFormAppearance = {
    ...
    CheckCircle: {
      createAppearanceStream: function () {
        var appearance = {
          N: {
            On: AcroFormAppearance.CheckCircle.YesNormal
          },
          D: {
            On: AcroFormAppearance.CheckCircle.YesPushDown,
            Off: AcroFormAppearance.CheckCircle.OffPushDown
          }
        };
      ...
      YesNormal: function (formObject) {
        var xobj = createFormXObject(formObject);
        var stream = [];
        var DotRadius = (AcroFormAppearance.internal.getWidth(formObject) / 3.4 <= AcroFormAppearance.internal.getHeight(formObject)) ?
        AcroFormAppearance.internal.getWidth(formObject) / 3.4 : AcroFormAppearance.internal.getHeight(formObject) / 3.4;
        DotRadius *= 0.9;
        var c = AcroFormAppearance.internal.Bezier_C;
        stream.push("q");
        stream.push("1 0 0 1 " + (AcroFormAppearance.internal.getWidth(formObject) / 2).toFixed(2) + " " + (AcroFormAppearance.internal.getHeight(formObject) / 2).toFixed(2) + " cm");
